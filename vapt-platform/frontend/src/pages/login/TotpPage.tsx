      ...
      <form onSubmit={submit} className="w-full max-w-sm panel p-7 space-y-5">
        <div className="flex items-center gap-2">
          ...
          <div>
            ...
            <div className="text-xs text-fg-muted">Enter the 6-digit code from your authenticator</div>
          </div>
        </div>
        <div>
          <label className="text-xs text-fg-muted">Authenticator code</label>
          <div className="relative mt-1">
            ...
            <input
              ...
              pattern="[0-9]{6,8}"
              placeholder="123456"
              className="w-full tracking-[0.4em] text-center bg-bg-soft border border-border-soft focus:border-accent rounded-lg pl-8 pr-3 py-2 text-lg outline-none font-mono"
            />
          </div>
        </div>
        <button
